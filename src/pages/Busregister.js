...
const schema = yup.object().shape({
  ...
  routes: yup.array().of(
    yup.object().shape({
      ...
      arrivalTimes: yup.array().of( // Added arrivalTimes validation
...
const RouteFields = ({ control, register, routeIndex, errors, onRemove }) => {
  ...
  // Added arrivalTimes field array
  ...
  const { 
    ...
    defaultValues: {
      routes: [{
        ...
        endPoint: '',
        departureTimes: [''],
        arrivalTimes: [''] // Added initial arrivalTimes
      }]
    }
  });
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <button
            ...
            onClick={() => appendRoute({
              ...
              endPoint: '',
              departureTimes: [''],
              arrivalTimes: [''] // Added to new routes
            })}
